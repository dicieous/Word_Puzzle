...
Shader "AdultLink/HorizontalDissolve"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float temp_output_2_0 = (( _Wave1amplitude * sin( ( Noise210 + (( temp_output_208_0 + break213.y )*_Wave1frequency + _Wave1offset) ) ) ) + break213.x + ( sin( ( (( break213.z + temp_output_208_0 )*_Wave2Frequency + _Wave2offset) + Noise210 ) ) * _Wave2amplitude ) );
