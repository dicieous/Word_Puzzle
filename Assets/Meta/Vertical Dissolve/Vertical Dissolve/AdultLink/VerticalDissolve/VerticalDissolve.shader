...
Shader "AdultLink/VerticalDissolve"
{
	...
	{
		_Fill("Fill", Float) = 1
		[HDR]_Blackcolor("Black color", Color) = (0,0.8344827,1,1)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float secondMaterialTransparency = 1.0 - ColorMask156;
			float4 finalColor = switchResult157 * ColorMask156 + (secondMaterialTransparency * float4(0, 0, 0, 1));
