...
public class MonitizationScript : MonoBehaviour
{
    ...
    [Header("Coin Animation Details")] public Sprite coinImage;
    public GameObject giftObject;
    public GameObject giftCoinInstancePos;
    public GameObject giftCoinMovePosition;
    [Header("Gift Details")] public Image giftImage;
    public UIParticle giftParticle;
    [Header("Magnet details")] public Sprite magnetImage;
    ...
    [Header("*2X Button Details")] public GameObject bubble2XParent;
    ...
    public void GiftBox_CallBack()
    {
        ...
        DOVirtual.DelayedCall(2, () => { giftImage.GetComponent<Button>().interactable = true; }, false);
    }
    ...
    {
        DOVirtual.DelayedCall(2f, () => { CoinManager.instance.CoinsIncrease(coinIncreaseNumber); }, false);
        for (int i = 0; i < 10; i++)
        {
            ...
            obj.GetComponent<RectTransform>().DOAnchorPos(movePosition.GetComponent<RectTransform>().anchoredPosition, 0.75f).SetEase(Ease.OutBack)
                .OnComplete(
                    () =>
                    {
                        obj.gameObject.SetActive(false);
